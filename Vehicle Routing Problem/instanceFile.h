...
public:
	...
	std::string getFileName(); // Returns file name of this instance file.
	int getOptimalValue(); // Returns best known value of an cVRP algorithm for this instance file.
