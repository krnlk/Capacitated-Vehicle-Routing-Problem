...
void specimen::mutateSwap(instanceFile instanceFile, std::pair<int, int> mutationPair) {
...
void specimen::mutateInvert(instanceFile instanceFile, std::pair<int, int> mutationPair) {
